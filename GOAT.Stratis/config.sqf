...
cityList = [
		["Town_1",100,"Spawn Area 1"],
		["Town_2",100,"Spawn Area 2"],
		["Town_3",100,"Spawn Area 3"],
		["Town_4",100,"Spawn Area 4"],			
		["Town_5",100,"Spawn Area 5"],
		["Town_6",100,"Spawn Area 6"],
		["Town_7",100,"Spawn Area 7"],
		["Town_8",100,"Spawn Area 8"],
		["Town_9",100,"Spawn Area 9"],
		["Town_10",100,"Spawn Area 10"],
		["Town_11",100,"Spawn Area 11"],
		["Town_12",100,"Spawn Area 12"]
];
cityLocations = [];
